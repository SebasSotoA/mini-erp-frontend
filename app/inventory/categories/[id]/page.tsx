...
import { Tags, ChevronUp, ChevronDown, X, Eye, Edit, Power, PowerOff, Trash2, Filter, Image as ImageIcon } from "lucide-react"
        ...
        <div className="flex flex-wrap gap-2">
          <div className="flex items-center gap-2">
            <Button
              ...
              className={`${isCategoryActive ? 'bg-camouflage-green-700 hover:bg-camouflage-green-800 text-white' : 'border-camouflage-green-300 text-camouflage-green-700 hover:bg-camouflage-green-50'}`}
              onClick={() => {
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              ...
              <AlertDialogFooter>
                ...
                <AlertDialogAction className="bg-red-600 hover:bg-red-700" onClick={() => { toast({ title: 'Categoría eliminada', description: `"${category.name}" fue eliminada.` }); router.push('/inventory/categories') }}>Eliminar</AlertDialogAction>
              </AlertDialogFooter>
            </AlertDialogContent>
          </AlertDialog>
        </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="space-y-1">
                ...
                <div className="text-camouflage-green-900 font-medium">{category.name}</div>
              </div>
              <div className="space-y-1">
                <div className="text-base text-camouflage-green-600">Descripción</div>
                <div className="text-camouflage-green-900 font-medium">{category.description}</div>
              </div>
              <div className="space-y-1">
                <div className="text-base text-camouflage-green-600">Estado</div>
                <div className="text-camouflage-green-900 font-medium">{category.isActive ? 'Activa' : 'Inactiva'}</div>
              </div>
            </div>
          </CardContent>
        </Card>
                  ...
                  <TableRow>
                    <TableCell colSpan={7} className="text-center py-12">
                      <div className="flex flex-col items-center gap-3">
                        ...
                        <div>
                          <p className="text-camouflage-green-600 font-medium">No hay ítems asociados a esta categoría</p>
                          <p className="text-camouflage-green-500 text-sm mt-1">Asigna productos a la categoría para verlos aquí.</p>
                        </div>
                      </div>
                    </TableCell>
                  </TableRow>
