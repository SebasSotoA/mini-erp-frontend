...
import { useFacturaVenta, useDeleteFacturaVenta } from "@/hooks/api/use-facturas-venta"
...
export default function SalesInvoiceDetailPage() {
  ...
  const { data: factura, isLoading, error } = useFacturaVenta(id)
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="flex items-center text-3xl font-bold text-camouflage-green-900">
              ...
              Factura de Venta {factura.numeroFactura}
            </h1>
          ...
          <div className="flex items-center gap-3">
            ...
            {!isAnulada && (
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    <AlertDialogTitle>¿Anular factura de venta?</AlertDialogTitle>
                    <AlertDialogDescription>
                      ...
                      <ul className="list-disc list-inside mt-2 space-y-1">
                        <li>Aumentará el stock de los productos en la bodega</li>
            ...
            <Card className="border-camouflage-green-200">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    <p className="text-sm font-medium text-camouflage-green-600">Bodega</p>
                  ...
                  <div className="space-y-1 md:col-span-2">
                    ...
                    <p className="text-lg text-camouflage-green-900">{factura.vendedorNombre}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm font-medium text-camouflage-green-600 flex items-center gap-2">
                    ...
                    <p className="text-lg text-camouflage-green-900">{factura.formaPago}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-sm font-medium text-camouflage-green-600">Medio de Pago</p>
                    <p className="text-lg text-camouflage-green-900">{factura.medioPago}</p>
                  </div>
                  {factura.formaPago === "Credito" && factura.plazoPago && (
                    <div className="space-y-1">
                      <p className="text-sm font-medium text-camouflage-green-600">Plazo de Pago</p>
                      <p className="text-lg text-camouflage-green-900">{factura.plazoPago} días</p>
                    </div>
                  )}
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="border-camouflage-green-200 hover:bg-transparent">
                      ...
                      <TableHead className="font-semibold text-camouflage-green-700 text-right">Precio Unitario</TableHead>
                    ...
                    {factura.items.length === 0 ? (
                      ...
                      factura.items.map((item) => (
                        <TableRow key={item.id} className="border-camouflage-green-100 hover:bg-camouflage-green-50/50">
                          ...
                          <TableCell className="text-right text-camouflage-green-900">{formatCurrency(item.precioUnitario)}</TableCell>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-700 mt-1">
                        Esta factura ha sido anulada. El stock de los productos ha sido restaurado.
                      </p>
                    </div>
                  </div>
                </CardContent>
