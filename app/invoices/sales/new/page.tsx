        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              size="md2"
              onClick={() => router.back()}
              className="text-camouflage-green-600 hover:text-camouflage-green-800 border border-camouflage-green-300 hover:bg-camouflage-green-50"
            >
            ...
            <Card className="w-full max-w-md border-camouflage-green-200">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-2 pt-4">
                  ...
                  <Button
                    variant="outline"
                    onClick={() => setShowNewSalesperson(false)}
